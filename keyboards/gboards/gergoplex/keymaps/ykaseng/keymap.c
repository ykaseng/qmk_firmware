...
[_NAVR] = LAYOUT_split_3x5_3(
    ...
    HOME_A, HOME_O, HOME_E, HOME_U, KC_NA,              KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_CAPS,
    KC_NA,  KC_NA,  KC_NA,  KC_NA,  KC_NA,              KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_INS,
...
[_FUNL] = LAYOUT_split_3x5_3(
    ...
    KC_F11,  KC_F4,   KC_F5,   KC_F6,   KC_SLCK,        KC_NA,   HOME_H,  HOME_T,  HOME_N,  HOME_S,
